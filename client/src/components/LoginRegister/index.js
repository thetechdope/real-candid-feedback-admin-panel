			...
			{signin === "signin" ? (
				...
				>
					<div className="form-content">
						...
						<FormControl>
							<FormGroup>
								<TextField id="email" label="Email Address" size="small" variant="outlined" />
							</FormGroup>
							<FormGroup>
								<TextField id="passsword" label=" Password" size="small" variant="outlined" />
							</FormGroup>
							<FormGroup>
					...
					<div className="form-content">
						...
						<FormControl>
							...
							<FormGroup>
								...
								<TextField id="Password" size="small" type="password" variant="outlined" />
							</FormGroup>
							<FormGroup>
